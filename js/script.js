...
var rABS = typeof FileReader !== "undefined" && typeof FileReader.prototype !== "undefined" && typeof FileReader
    .prototype.readAsBinaryString !== "undefined";
if (!rABS) {
...
function ab2str(data) {
    var o = "",
        l = 0,
        w = 10240;
    for (; l < data.byteLength / w; ++l) o += String.fromCharCode.apply(null, new Uint16Array(data.slice(l * w, l * w +
        w)));
...
function process_wb(wb) {
    ...
    // $.post(base_url + "import/import_data/", {
    //     json: output,
    // }, function(data) {
    //     if(data>=0){
    //         swal(
